...
CFLAGS = -O2 -Wall -pipe -DGLES1 -DN900

CFLAGS += -Isrc -Isrc/include -Isrc/win95 -Isrc/avp -Isrc/avp/win95 -Isrc/avp/support -Isrc/avp/win95/frontend -Isrc/avp/win95/gadgets -Isrc/Video
CFLAGS += $(shell sdl-config --cflags) $(shell pkg-config openal --cflags)
CXXFLAGS = $(CFLAGS)

LDLIBS = $(shell sdl-config --libs) -lSDL_net -lEGL -lX11 $(shell pkg-config openal --libs)
...
AVPWIN95 = avpchunk.cpp cheat.c chtcodes.cpp d3d_hud.cpp ddplat.cpp endianio.c ffread.cpp ffstdio.cpp gammacontrol.cpp hierplace.cpp iofocus.cpp jsndsup.cpp kzsort.c langplat.c modcmds.cpp npcsetup.cpp objsetup.cpp pathchnk.cpp platsup.c pldghost.c pldnet.c progress_bar.c projload.cpp scrshot.cpp strachnk.cpp system.c vision.c
...
INPUT = JoystickInput.c MenuInput.c usr_io.c
VIDEO = OpenGLInit.c VideoModes.c
...
VIDEOSRC = $(call SRCNAMES,$(VIDEO),src/Video)
VIDEOOBJ =  $(call OBJNAMES,$(VIDEO),src/Video)
INPUTSRC = $(call SRCNAMES,$(INPUT), src/Input)
INPUTOBJ = $(call OBJNAMES,$(INPUT), src/Input)

SRC = $(ROOTSRC) $(AVPSRC) $(SHAPESSRC) $(SUPPORTSRC) $(AVPWIN95SRC) $(FRONTENDSRC) $(GADGETSSRC) $(WIN95SRC) $(VIDEOSRC) $(INPUTSRC)
OBJ = $(ROOTOBJ) $(AVPOBJ) $(SHAPESOBJ) $(SUPPORTOBJ) $(AVPWIN95OBJ) $(FRONTENDOBJ) $(GADGETSOBJ) $(WIN95OBJ) $(VIDEOOBJ) $(INPUTOBJ)
